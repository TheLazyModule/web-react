                ...
                <div className="max-w-sm" ref={dropdownRef}>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            type="text"
                            placeholder={`Search your ${type === "from" ? "location" : "destination"}`}
                            value={searchText}
                    ...
                    {dropdownVisible && isFetched && searchText && searchText.length >= 2 && (
                        <div
                            className="absolute z-50 w-[68%] bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-800">
                                        ...
                                        <div className="flex justify-between items-center w-full">
                                            <div className="flex flex-row justify-between w-full ">
                                                <img src={categoriesData.find(c => c.id === r.category_id)?.img}
                                                     className='h-5'
                                                     alt=""/>
                                                <span className='text-right'>{r.name}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
